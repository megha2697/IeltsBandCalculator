...
import in.ac.darshan.www.ielts.activities.*;
...
//        btn_dialog = findViewById(R.id.btn_dialog);
        ...
        btn_accob.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, in.ac.darshan.www.ielts.activities.ACADEMIC_OVERALL_BAND.class);
                startActivity(intent);
            }
        });
        ...
        btn_dialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, in.ac.darshan.www.ielts.activities.DIALOG.class);
                startActivity(intent);
            }
        });
